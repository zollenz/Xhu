...
{    
    ...
    static const F32 F32_TOLERANCE = 0.001f;
...
#define F32_INF std::numeric_limits<F32>::infinity()
    ...
    struct mqCoordinate
    {
        ...
        mqCoordinate(S32 _x = 0, S32 _y = 0) : x(_x), y(_y) {}
    };
    ...
    typedef std::vector<mqCoordinate> CoordList;
    typedef std::vector<mqSegment> SegList;
