...
const mq_s32_t mq_get_table_data(const mq_s32_t table_id, mq_audio_data_t *data)
{
    mq_s32_t length = -1;
...
void mq_set_table_data(const mq_s32_t table, const mq_audio_data_t *const data, mq_u32_t data_count)
{
